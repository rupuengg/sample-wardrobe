...
export const mockWardrobes: IWardrobeModel[] = [
  {
    ...
    pieces: [
      ...getPieces(size),
      { category: E_Category.PARTITION, type: E_Position.HORIZONTAL_PARTITION, position: WardrobeUtils(size).partitionHPositionFromBottomLeft({ width: 36, height: BoardThickness.EIGHTEEN_MM, depth: size2.depth }, 0, BoardThickness.EIGHTEEN_MM), size: { width: 36, height: BoardThickness.EIGHTEEN_MM, depth: size2.depth } },
      ...
      // { category: E_Category.PARTITION, type: E_Position.PARTITION_H, position: WardrobeUtils(size).partitionFromTopPosition(-48, BoardThickness.EIGHTEEN_MM), size: { width: 24 - BoardThickness.SIX_MM, height: 36 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
      // { category: E_Category.PARTITION, type: E_Position.PARTITION_H, position: WardrobeUtils(size).partitionFromTopPosition(-58, BoardThickness.EIGHTEEN_MM), size: { width: 24 - BoardThickness.SIX_MM, height: 36 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
      // { category: E_Category.PARTITION, type: E_Position.PARTITION_H, position: WardrobeUtils(size).partitionFromTopPosition(-68, BoardThickness.EIGHTEEN_MM), size: { width: 24 - BoardThickness.SIX_MM, height: 36 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
  ...
  },
  {
    ...
    pieces: [
      ...
      { category: E_Category.PARTITION, type: E_Position.HORIZONTAL_PARTITION, position: WardrobeUtils(size2).partitionHPositionFromBottomLeft({ width: 24, height: 36, depth: BoardThickness.EIGHTEEN_MM }, 24, BoardThickness.EIGHTEEN_MM), size: { width: 24 - BoardThickness.SIX_MM, height: 36 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
      // { category: E_Category.PARTITION, type: E_Position.PARTITION_V, position: WardrobeUtils(size).partitionFromLeftPosition(-24, BoardThickness.EIGHTEEN_MM), size: { width: 24 - BoardThickness.SIX_MM, height: 84 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
      // { category: E_Category.PARTITION, type: E_Position.PARTITION_V, position: WardrobeUtils(size).partitionFromLeftPosition(-36, BoardThickness.EIGHTEEN_MM), size: { width: 24 - BoardThickness.SIX_MM, height: 84 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
      // { category: E_Category.PARTITION, type: E_Position.PARTITION_V, position: WardrobeUtils(size).partitionFromLeftPosition(-48, BoardThickness.EIGHTEEN_MM), size: { width: 24 - BoardThickness.SIX_MM, height: 84 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
    ]
  },
  {
    key: '72*84*24',
