...
export const mockWardrobes: IWardrobeModel[] = [
  {
    ...
    pieces: [
      ...
      { category: E_Category.PARTITION, type: E_Position.PARTITION_H, position: { x: 0, y: -12, z: 24 / 2 }, size: { width: 24 - BoardThickness.SIX_MM, height: 36 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
      { category: E_Category.PARTITION, type: E_Position.PARTITION_H, position: { x: 0, y: -22, z: 24 / 2 }, size: { width: 24 - BoardThickness.SIX_MM, height: 36 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
      { category: E_Category.PARTITION, type: E_Position.PARTITION_H, position: { x: 0, y: -32, z: 24 / 2 }, size: { width: 24 - BoardThickness.SIX_MM, height: 36 - (2 * BoardThickness.EIGHTEEN_MM), depth: BoardThickness.EIGHTEEN_MM } },
      { category: E_Category.DRAWER, type: E_Position.DRAWER, position: { x: 0, y: -22 + (10 / 2), z: 24 / 2 }, size: { width: 24 - BoardThickness.SIX_MM, height: 36 - (2 * BoardThickness.EIGHTEEN_MM), depth: 10 - (BoardThickness.EIGHTEEN_MM) } },
      { category: E_Category.DRAWER, type: E_Position.DRAWER, position: { x: 0, y: -32 + (10 / 2), z: 24 / 2 }, size: { width: 24 - BoardThickness.SIX_MM, height: 36 - (2 * BoardThickness.EIGHTEEN_MM), depth: 10 - (BoardThickness.EIGHTEEN_MM) } },
      ...
      { category: E_Category.DOOR, type: E_Position.DOOR, position: { x: -(36 / 4) - BoardThickness.GAP / 2, y: 0, z: 24 + BoardThickness.SIX_MM }, size: { width: 36 / 2 - BoardThickness.GAP, height: 84, depth: BoardThickness.EIGHTEEN_MM } },
      { category: E_Category.DOOR, type: E_Position.DOOR, position: { x: (36 / 4) + BoardThickness.GAP / 2, y: 0, z: 24 + BoardThickness.SIX_MM }, size: { width: 36 / 2 - BoardThickness.GAP, height: 84, depth: BoardThickness.EIGHTEEN_MM } },
    ]
  },
